<h1 align="center">
    <a href="https://ibb.co/mBtjd47"><img src="https://i.ibb.co/KG7PBWH/logo.png" alt="logo" border="0"></a>
</h1>
...
<p align="center">
  <a href="https://ibb.co/BtkwCqj"><img src="https://i.ibb.co/xDZ37JG/telaToDo.png" alt="Desktop to.do" border="0"></a>
</p>
...
O To-do é uma pequena aplicação de atividades a fazer, para treinar um pouco mais sobre manipulação do estado no React 😄.

Este projeto é um desafio oferecido pela Rocketseat referente ao módulo 1 da Trilha ReactJS.
...
```bash
# Clone o repositório
git clone https://github.com/larissadantier/desafio01-trilha-reactjs.git
